...
bool CheckIssueDataTx(const CTxOut& txOut); // OP_RAVEN_ASSET ALEXQ (That is a Q as in Que not an O)
bool CheckOwnerDataTx(const CTxOut& txOut);// OP_RAVEN_ASSET ALEXO
bool CheckReissueDataTx(const CTxOut& txOut);// OP_RAVEN_ASSET ALEXR
bool CheckTransferOwnerTx(const CTxOut& txOut);// OP_RAVEN_ASSET ALEXT
