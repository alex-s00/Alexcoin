...
/** Alex unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class AlexUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit AlexUnits(QObject *parent);
...
typedef AlexUnits::Unit AlexUnit;
