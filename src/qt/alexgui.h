...
/**
  Alex GUI main class. This class represents the main window of the Alex UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class AlexGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit AlexGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~AlexGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a alex wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
