...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, AlexUnits::SeparatorStyle separators=AlexUnits::separatorStandard) const;
