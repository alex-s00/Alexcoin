...
/* AlexGUI -- Size of icons in status bar */
...
/* Alexcoin dark orange */
#define COLOR_DARK_ORANGE QColor("#f05239")
/* Alexcoin light orange */
...
/* Alexcoin shadow color - light mode */
...
/* Alexcoin label color as a string */
...
#define QAPP_ORG_NAME "Alex"
#define QAPP_ORG_DOMAIN "alex.org"
#define QAPP_APP_NAME_DEFAULT "Alex-Qt"
#define QAPP_APP_NAME_TESTNET "Alex-Qt-testnet"

/* Default third party browser urls */
#define DEFAULT_THIRD_PARTY_BROWSERS "https://api.alexcoin.org/tx/%s|https://rvn.cryptoscope.io/tx/?txid=%s|https://blockbook.alexcoin.org/tx/%s|https://explorer.mangofarmassets.com/tx/%s|https://www.assetsexplorer.com/tx/%s|https://explorer.alexland.org/tx/%s"
