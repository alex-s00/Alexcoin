...
#include "config/alex-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatAlexURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + AlexUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatAlexURI(info));
}
