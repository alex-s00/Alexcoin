...
public:
    explicit TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(AlexUnits::ALEX),
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(AlexUnits::formatWithUnit(unit, balance, false, AlexUnits::separatorAlways));
    ui->labelUnconfirmed->setText(AlexUnits::formatWithUnit(unit, unconfirmedBalance, false, AlexUnits::separatorAlways));
    ui->labelImmature->setText(AlexUnits::formatWithUnit(unit, immatureBalance, false, AlexUnits::separatorAlways));
    ui->labelTotal->setText(AlexUnits::formatWithUnit(unit, balance + unconfirmedBalance + immatureBalance, false, AlexUnits::separatorAlways));
    ui->labelWatchAvailable->setText(AlexUnits::formatWithUnit(unit, watchOnlyBalance, false, AlexUnits::separatorAlways));
    ui->labelWatchPending->setText(AlexUnits::formatWithUnit(unit, watchUnconfBalance, false, AlexUnits::separatorAlways));
    ui->labelWatchImmature->setText(AlexUnits::formatWithUnit(unit, watchImmatureBalance, false, AlexUnits::separatorAlways));
    ui->labelWatchTotal->setText(AlexUnits::formatWithUnit(unit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, AlexUnits::separatorAlways));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("ALEX")
    updateDisplayUnit();
}
...
void OverviewPage::showAssets()
{
    if (AreAssetsDeployed()) {
        ...
        // This keeps the ALEX balance grid from expanding and looking terrible when asset balance is hidden
