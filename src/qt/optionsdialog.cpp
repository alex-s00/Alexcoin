    ...
    mapper(0)
{
    ...
    ui->alexAtStartup->setToolTip(ui->alexAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->alexAtStartup->setText(ui->alexAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openAlexConfButton->setToolTip(ui->openAlexConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new AlexUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->alexAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openAlexConfButton_clicked()
{
