...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<AlexAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_alex-qt -platform xcb      # Linux
//     src/qt/test/test_alex-qt -platform windows  # Windows
//     src/qt/test/test_alex-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = AlexUnits::formatWithUnit(unit, balance, false, AlexUnits::separatorAlways);
    ...
    // Amount input
    AlexAmountField* amountInput = receiveCoinsDialog.findChild<AlexAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: alex:")) != -1);
