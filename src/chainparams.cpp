...
public:
    CMainParams() {
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].nStartTime = 1711234300; // January 1, 2008
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].nTimeout = 1712333300; // December 31, 2008
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_ASSETS].nStartTime = 1711234300; // Oct 31, 2018
        consensus.vDeployments[Consensus::DEPLOYMENT_ASSETS].nTimeout = 1712333300; // Oct 31, 2019
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_MSG_REST_ASSETS].nStartTime = 1711234300; // UTC: Mon Jan 13 2020 13:00:00
        consensus.vDeployments[Consensus::DEPLOYMENT_MSG_REST_ASSETS].nTimeout = 1712333300; // UTC: Wed Jan 13 2021 13:00:00
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_TRANSFER_SCRIPT_SIZE].nStartTime = 1711234300; // UTC: Wed May 06 2020 18:00:00
        consensus.vDeployments[Consensus::DEPLOYMENT_TRANSFER_SCRIPT_SIZE].nTimeout = 1712333300; // UTC: Thu May 06 2021 18:00:00
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_ENFORCE_VALUE].nStartTime = 1711234300; // UTC: Mon Jun 29 2020 18:00:00
        consensus.vDeployments[Consensus::DEPLOYMENT_ENFORCE_VALUE].nTimeout = 1712333300; // UTC: Mon Jun 29 2021 18:00:00
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_COINBASE_ASSETS].nStartTime = 1711234300; // UTC: Thu Aug 13 2020 18:00:00
        consensus.vDeployments[Consensus::DEPLOYMENT_COINBASE_ASSETS].nTimeout = 1712333300; // UTC: Fri Aug 13 2021 18:00:00
        ...
        genesis = CreateGenesisBlock(1711230000, 21809571, 0x1e00ffff, 4, 5000 * COIN);

        consensus.hashGenesisBlock = genesis.GetX16RHash();
        
        assert(consensus.hashGenesisBlock == uint256S("0000006a441bbdbb0bc082c06de2a77a27da747cc139543f1ec70ae89784c3f1"));
        assert(genesis.hashMerkleRoot == uint256S("28ff00a867739a352523808d301f504bc4547699398d70faf2266a8bae5f3516"));

        vSeeds.emplace_back("seed-alex.bitactivate.com", false);
        vSeeds.emplace_back("seed-alex.alexcoin.com", false);
        vSeeds.emplace_back("seed-alex.alexcoin.org", false);
        ...
        // Alex BIP44 cointype in mainnet is '175'
        nExtCoinType = 175;
        ...
        chainTxData = ChainTxData{
            // Update as we know more about the contents of the Alex chain
            // Stats as of 0x00000000000016ec03d8d93f9751323bcc42137b1b4df67e6a11c4394fd8e5ad window size 43200
            1711230000, // * UNIX timestamp of last known number of transactions
        ...
        nKAAAWWWPOWActivationTime = 1712223300; // UTC: Wed May 06 2020 18:00:00
...
public:
    CTestNetParams() {
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].nTimeout = 1730767999; // December 31, 2008
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_ASSETS].nTimeout = 1777257200; // UTC: Wed Dec 25 2019 07:00:00
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_MSG_REST_ASSETS].nTimeout = 1777257200; // UTC: Wed Dec 25 2019 07:00:00
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_TRANSFER_SCRIPT_SIZE].nTimeout = 1718509600; // UTC: Thu Apr 15 2021 18:00:00
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_ENFORCE_VALUE].nTimeout = 1724989600; // UTC: Mon Jun 29 2021 18:00:00
        consensus.vDeployments[Consensus::DEPLOYMENT_ENFORCE_VALUE].nOverrideRuleChangeActivationThreshold = 1411; // Approx 70% of 2016
        consensus.vDeployments[Consensus::DEPLOYMENT_ENFORCE_VALUE].nOverrideMinerConfirmationWindow = 2016;
        consensus.vDeployments[Consensus::DEPLOYMENT_COINBASE_ASSETS].bit = 10;
        consensus.vDeployments[Consensus::DEPLOYMENT_COINBASE_ASSETS].nStartTime = 1597341600; // UTC: Thu Aug 13 2020 18:00:00
        consensus.vDeployments[Consensus::DEPLOYMENT_COINBASE_ASSETS].nTimeout = 1728877600; // UTC: Fri Aug 13 2021 18:00:00
        consensus.vDeployments[Consensus::DEPLOYMENT_COINBASE_ASSETS].nOverrideRuleChangeActivationThreshold = 1411; // Approx 70% of 2016
        consensus.vDeployments[Consensus::DEPLOYMENT_COINBASE_ASSETS].nOverrideMinerConfirmationWindow = 2016;
        ...
        uint32_t nGenesisTime = 1711230000;		//1711230000;  // 2021-02-19 08:00:00
        ...
        for (int i=0;i<40000000;i++) {
            genesis = CreateGenesisBlock(1711230000, i, 0x1e00ffff, 4, 5000 * COIN);
        ...
        std::cout << "genesis.GetHash().GetHex() to 0x" << genesis.GetX16RHash().GetHex() << std::endl;
		...
		*/
        ...
        genesis = CreateGenesisBlock(1613693000, 3065180, 0x1e00ffff, 4, 5000 * COIN);
        consensus.hashGenesisBlock = genesis.GetX16RHash();
...
//        /////////////////////////////////////////////////////////////////
        ...
        // Alex BIP44 cointype in regtest
        nExtCoinType = 1;
