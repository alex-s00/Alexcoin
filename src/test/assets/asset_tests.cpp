...
BOOST_FIXTURE_TEST_SUITE(asset_tests, BasicTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(name_validation_tests)
    {
        ...
        BOOST_CHECK(!IsAssetNameValid("ALEX", type));
        ...
        BOOST_CHECK(IsAssetNameValid("ALEXSPYDER", type));
        BOOST_CHECK(IsAssetNameValid("SPYDERALEX", type));
        ...
        BOOST_CHECK(IsAssetNameValid("SEALEXOT", type));
