Contributing to Alex Core
============================

The Alex Core project operates an open contributor model where anyone is
...
the pull request affects. Valid areas as:
  ...
  - *GUI* for changes to alex-qt
  - *Mining* for changes to the mining code
  - *Net* or *P2P* for changes to the peer-to-peer network code
  - *RPC/REST/ZMQ* for changes to the RPC, REST or ZMQ APIs
  - *Scripts and tools* for changes to the scripts and tools
  - *Tests* for changes to the alex unit tests or QA tests
...
The following applies to code changes to the Alexcoin project (and related
projects) and is not to be confused with overall Alexcoin
Network Protocol consensus changes.

Whether a pull request is merged into Alexcoin rests with the project merge
...
Patches that change Alexcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Alexcoin consensus, it must have been
...
The AlexQT-SIG selects a release manager for each Alexcoin release.
