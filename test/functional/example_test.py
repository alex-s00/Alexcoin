...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the AlexTestFramework
    pass

class ExampleTest(AlexTestFramework):
    # Each functional test is a subclass of the AlexTestFramework class.
    ...
    def custom_method(self):
        ...
        AlexTestFramework class so other tests can use it."""
