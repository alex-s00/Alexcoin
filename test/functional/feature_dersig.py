...
class BIP66Test(AlexTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # alexd is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and alexd produces more specific reject
            # reasons.
