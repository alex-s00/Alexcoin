...
class WalletTest(AlexTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 ALEX from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 ALEX with subtract fee from amount
        ...
        # Sendmany 10 ALEX with subtract fee from amount
