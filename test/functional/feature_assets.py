...
class AssetTest(AlexTestFramework):
    ...
    def big_test(self):
        ...
        alex_assets = n0.listassets(asset="RAVEN*", verbose=False, count=2, start=-2)
        assert_equal(len(alex_assets), 2)
        assert_equal(alex_assets[0], "RAVEN2")
        assert_equal(alex_assets[1], "RAVEN3")
        self.sync_all()
