...
# TestNode: A peer we use to send messages to alexd, and store responses.
...
class CompactBlocksTest(AlexTestFramework):
    ...
    # This test actually causes alexd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that alexd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for alexd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(node, test_node, version):
        # alexd will not send blocktxn responses for blocks whose height is
