...
class TestAlexCli(AlexTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `alex-cli getinfo`")
        ...
        self.log.info("Compare responses from `alex-cli -getinfo` and the RPCs data is retrieved from.")
