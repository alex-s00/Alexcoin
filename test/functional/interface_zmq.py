...
import os
import struct
from test_framework.test_framework import AlexTestFramework, SkipTest
...
# noinspection PyUnresolvedReferences
class ZMQTest(AlexTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that alex has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("alexd has not been built with zmq enabled.")
