...
By default, alexd will dump mempool on shutdown and
...
class MempoolPersistTest(AlexTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give alexd a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent alexd from writing mempool.dat to disk. Verify that `savemempool` fails")
