...
class TxnMallTest(AlexTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 ALEX:
        ...
        # First: use raw transaction API to send 1240 ALEX to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 ALEX coin each
        ...
        # Node0's balance should be starting balance, plus 50ALEX for another
        ...
        # Node0's total balance should be starting balance, plus 100ALEX for 
