...
find ${DISTNAME}/bin -type f -executable -exec ../alexcoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../alexcoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/alexcoin/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/alexcoin/depends/SDKs/MacOSX10.11.sdk.tar.gz
