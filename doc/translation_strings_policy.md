...
This document provides guidelines for internationalization of the Alex Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `alex_en.ts` remains unchanged.
