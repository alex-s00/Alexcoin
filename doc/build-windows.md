...
Below are some notes on how to build Alex Core for Windows.
...
way. This will install to `c:\workspace\alex`, for example:

    make install DESTDIR=/mnt/c/workspace/alex
