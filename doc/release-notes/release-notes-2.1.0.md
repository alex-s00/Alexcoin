Alex Core version *2.1.0* is now available!!
==============

  <https://github.com/AlexProject/Alexcoin/releases/tag/v2.1.0>
...
Changelog available here: <https://github.com/AlexProject/Alexcoin/commits/release_2.1.0>
